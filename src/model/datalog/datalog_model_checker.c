...
//                char *relNameLower = (char *) MALLOC((strlen(relName) + 1));
//                strcpy(relNameLower,relName);
//                boolean lowerCaseRel = FALSE;
//
//                if (!catalogTableExists(relName))
//                {
//                    stringLwr(relNameLower);
//                    lowerCaseRel = TRUE;
//                }

                if (catalogTableExists(relName))
//                		|| catalogTableExists(relNameLower))
                {
